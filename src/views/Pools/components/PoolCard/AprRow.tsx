...
const AprRow: React.FC<AprRowProps> = ({ pool, stakedBalance, performanceFee = 0 }) => {
  ...
  const tooltipContent = isAutoVault
    ? t('APY includes compounding, APR doesn’t. This pool’s ICC is compounded automatically, so we show APY.')
  ...
  return (
    <Flex alignItems="center" justifyContent="space-between">
      ...
      <TooltipText style={{color:'#5922c8'}} ref={targetRef}>{isAutoVault ? `${t('APY')}:` : `${t('APR')}:`}</TooltipText>
