...
const Farms: React.FC = () => {
  ...
  const rowData = chosenFarmsMemoized.map((farm) => {
    ...
    const lpLabel = farm.lpSymbol && farm.lpSymbol.split(' ')[0].toUpperCase().replace('Cockroach', '')
  ...
  return (
    <>
      <PageHeader onLoad={useModalCustom}>
          ...
          <ViewControls>
            ...
            <ToggleWrapper>
              <Toggle
                ...
                scale="sm"
              />
              <Text style={{color:'#5922c8'}}> {t('Staked only')}</Text>
            </ToggleWrapper>
